...
?>
<style>
	.index-current-event .competition { padding-top: 10px; }
	.index-current-event .competition .title { font-size: 18px; font-weight: bold; }
	.index-current-event .competition .info { font-size: 13px; color: #888; }
</style>
<?php 
// Prerendered in 'main.tpl'
echo '<div class="hidden-md hidden-lg" style="margin-bottom: 10px;">'.NFW::i()->timeline.'</div>';
...
<div class="hidden-md hidden-lg" style="margin-bottom: 40px; text-align: center;"><div id="zxbn-index-container"></div></div><?php 
...
<div style="margin-bottom: 40px; text-align: center;">
	<a class="btn btn-lg btn-primary btn-events-main" href="<?php echo NFW::i()->absolute_path?>/events"><?php echo $lang_main['all events']?></a>
</div>

<?php
echo '<div class="hidden-md hidden-sm hidden-lg">';
echo '<h2 class="index-head">'.$lang_main['latest news'].'</h2>';
echo NFW::i()->latest_news;
	...
	<div class="row">
		<div class="col-sm-12 col-md-5">
			<a href="<?php echo NFW::i()->base_path.$record['alias']?>">
				<img src="<?php echo $record['preview_img_large'] ? $record['preview_img_large'] : NFW::i()->assets('main/current-event-large.png')?>" style="width: 100%; margin-top: 20px;" />
			</a>
		</div>
		<div class="col-sm-12 col-md-7">
			<h2><a href="<?php echo NFW::i()->base_path.$record['alias']?>"><?php echo htmlspecialchars($record['title'])?></a></h2>
...
<div class="index-current-event" style="padding-bottom: 20px;">
	...
	<div class="hidden-sm hidden-md hidden-lg">
		...
		<div class="competition">
			<div class="title"><a href="<?php echo  NFW::i()->absolute_path.'/'.$c['event_alias'].'/'.$c['alias']?>"><?php echo htmlspecialchars($c['title'])?></a></div>
			<div class="info">
				<div>
	...
	<table class="table table-condensed hidden-xs">
		...
		<?php foreach ($competitions as $c) { ?>
		<tr >
			<td class="nw"><a href="<?php echo  NFW::i()->absolute_path.'/'.$c['event_alias'].'/'.$c['alias']?>"><?php echo htmlspecialchars($c['title'])?></a></td>
