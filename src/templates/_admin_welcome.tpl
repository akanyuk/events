...
if (!empty($managed_events)) {
    ...
    list($uncheckedProdsCount) = NFW::i()->db->fetch_row($result);
    ...
    $query['LIMIT'] = MAX_UNCHECKED_PRODS;
            ...
            <?php else: ?>
                <div class="hidden-xs">
                    <div class="pull-right">
                        <button id="works-set-checked-all" class="btn btn-success"><span class="fa fa-check"></span> Set
                            all prods checked <span class="badge"><?php echo $uncheckedProdsCount ?></span></button>
                    </div>
                    <h2>Unchecked prods</h2>
                    <table class="table table-condensed table-striped">
                        ...
                        <?php if (count($unchecked_prods) < $uncheckedProdsCount): ?>
                            <tfoot>
                            <tr>
                                <td colspan="3">Showing last <strong><?php echo count($unchecked_prods) ?></strong>
                                    of <strong><?php echo $uncheckedProdsCount ?></strong>
                                    unchecked prods
                                </td>
                            </tr>
                            </tfoot>
                ...
                <div class="hidden-sm hidden-md hidden-lg">
                    ...
                    <table class="table table-condensed table-striped">
                        ...
                        <?php foreach ($unchecked_prods as $record) { ?>
                            <tr>
                                <td>
                                    ...
                                    <div>
                                        Posted <?php echo date('d.m.Y H:i', $record['posted']) . ' by ' . htmlspecialchars($record['posted_username']) ?></div>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
                        <?php if (count($unchecked_prods) < $uncheckedProdsCount): ?>
                            <tfoot>
                            <tr>
                                <td>Showing last <strong><?php echo count($unchecked_prods) ?></strong>
                                    of <strong><?php echo $uncheckedProdsCount ?></strong>
                                    unchecked prods
                                </td>
                            </tr>
                    ...
                    <div style="text-align: center">
                        <button id="works-set-checked-all" class="btn btn-lg btn-success"><span
                                    class="fa fa-check"></span> Set all prods checked <span
                                    class="badge"><?php echo $uncheckedProdsCount ?></span></button>
                    </div>
                </div>
            <?php endif; ?>
        </div>
