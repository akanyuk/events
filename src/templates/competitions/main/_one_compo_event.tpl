...
<table class="table table-compo-status">
    ...
    <?php if ($competition['reception_from']): ?>
        <tr>
            ...
            <td>
                <span class="badge <?php echo $competition['reception_status']['label-class'] ?>"><strong><?php echo $competition['reception_status']['desc'] ?></strong></span>
            </td>
    ...
    <?php if ($competition['voting_from']): ?>
        <tr>
            ...
            <td>
                <span class="badge <?php echo $competition['voting_status']['label-class'] ?>"><strong><?php echo $competition['voting_status']['desc'] ?></strong></span>
            </td>
    ...
    <?php if ($showWorksCount): ?>
        <tr>
            ...
            <td>
                <span class="badge <?php echo $worksLabelClass ?>"><strong><?php echo $competition['voting_works'] ?></strong></span>
            </td>
            <td>&nbsp;</td>
        </tr>
    <?php endif; ?>
