...
foreach ($CCompetitionsGroups->getRecords($Module->record['event_id']) as $group) {
            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-10">
                        <div class="alert alert-warning alert-dismissible">
                            ...
                            Если не указаны даты начала и окончания голосования, <br/>то все принятые этого компо будут
                            отображаться сразу же после принятия оператором!
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right" style="padding-top: 20px;">
                        <a id="competitions-delete" href="#" class="text-danger" title=""><span
                                    class="fa fa-times"></span> Delete competition</a>
                    </div>
                </div>
            </fieldset>
        </form>
            ...
            <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                    <li role="presentation"><a
                                href="<?php echo NFW::i()->base_path . 'admin/works?event_id=' . $Module->record['event_id'] ?>"
                                title="Manage works of this events">Manage works</a></li>
                    <li role="presentation"><a
                                href="<?php echo NFW::i()->base_path . 'admin/vote?event_id=' . $Module->record['event_id'] ?>"
