...
$lang_main = array(
    ...
    'works upload info' => '<p>Загруженные файлы будут сохранены на сервере только после нажатия кнопки «Отправить работу».</p><p>Вы можете загрузить несколько файлов (скриншот, файл для голосования, архив для релиза).</p><p>После проверки организаторами на Ваш e-mail адрес будет выслано оповещение о&nbsp;текущем статусе работы.</p>',
    'works upload success title' => 'Работа загружена',
    'works upload success message' => 'Работа успешно загружена. После проверки организаторами Вы получите e-mail оповещение о&nbsp;текущем статусе работы.',
