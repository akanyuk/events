...
$lang_main = array(
    ...
    'works description refs options' => array('Да', 'Нет', 'Другое (в комментарии)'),
    'works on compo canceled' => 'Если конкурс будет отменен',
    'works on compo canceled options' => array('Показать работу вне конкурса (без голосования)','Не публиковать работу (будет отправлена на другой конкурс)', 'Другое (в комментарии)'),
