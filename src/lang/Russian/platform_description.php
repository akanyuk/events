...
$lang_platform_description = array(
    ...
    'Commodore C64' => array(
        'picture' => array(
            'default' => array(
                'Разрешение: 320х200, 2 цвета на знакоместо 8×8',
                'Разрешение: 160×200, 3 основных цвета и 1 цвет фона на знакоместо 4×8',
                'Палитра: 16 цветов'
            ),
        )
    ),
    ...
    'Amstrad CPC' => array(
        ...
        'picture' => array(
            ...
            'Mode 0' => array(
                'Разрешение 160×200px, 16 цветов из палитры 27 цветов.',
            ),
            'Mode 1' => array(
                'Разрешение 320×200px, 4 цвета из палитры 27 цветов',
            ),
            'Mode 2' => array(
                'Разрешение 640×200px, 2 цвета из палитры 27 цветов.',
            ),
        )
    ),
);
